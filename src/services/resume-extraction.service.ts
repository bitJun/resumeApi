import { CandidateRecord, ResumeExtraction } from "../types/index.js";
import { wait } from "../utils/time.js";
import { extractResumeHeuristically } from "./heuristic.service.js";
import { extractResumeWithAI } from "./openai.service.js";

function mergeExtraction(primary: ResumeExtraction, fallback: ResumeExtraction): ResumeExtraction {
  return {
    basicInfo: {
...
export async function extractResume(candidate: CandidateRecord) {
...
export async function streamResumeExtraction(
  ...
  const sections: Array<[string, unknown, number, string]> = [
